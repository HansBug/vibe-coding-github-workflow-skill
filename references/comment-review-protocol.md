# Comment Review Protocol (WIP)

This reference will define how a vibe coding session treats GitHub comments as the primary review ledger.
...
This file is intentionally a placeholder until the FS-C phase expands the protocol.
